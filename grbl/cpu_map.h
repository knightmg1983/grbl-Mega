...
#define cpu_map_h
  ...
  // Advanced Configuration Below You should not need to touch these variables
  // Set Timer up to use TIMER4A which is attached to Digital Pin 6 - Ramps 1.4 Servo 2
  #define SPINDLE_PWM_MAX_VALUE     1024.0 // Translates to about 15.6 kHz PWM frequency at 1 prescaler
  #ifndef SPINDLE_PWM_MIN_VALUE
  #define SPINDLE_PWM_MIN_VALUE   1   // Must be greater than zero.
  #endif
  #define SPINDLE_PWM_OFF_VALUE     0
  ...
  // 1 Prescaler, 16-bit Fast PWM mode
  ...
  #define SPINDLE_PWM_DDR   DDRH
  #define SPINDLE_PWM_PORT  PORTH
  #define SPINDLE_PWM_BIT   3 // MEGA2560 Digital Pin 6, Ramps Servo 2
